        ...
        <div class="container">
            <div class="row">
                <div class="text-wrapper col-12 text-center" data-aos="fade-down" data-aos-delay="150">
                    <h1 class="text-center text-white heading-text">ACCOUNTANT</h1>
                    <h6 class="text-center text-white">ODS - Finance</h6>
                </div>
            </div>
    </section>
            ...
            <div class="col-lg-7 pe-2 pe-md-5">
              <div>
                <div>
                  ...
                  <div><br></div>
                  <div>
                    <span style="font-size: 16px">Manajer Akun akan mengelola sejumlah kecil pedagang UKM dengan pendapatan lebih tinggi dan pertumbuhan lebih tinggi. Di beberapa kabupaten, AM mungkin mengelola AE. Tanggung jawab utama adalah memastikan bahwa pedagang terus berkembang untuk mencapai target.</span>
                  </div>
                </div>
                <div>
                    <br>
                ...
                <ul>
                  ...
                  <li>Tugas lain yang diberikan terkait dengan mosi Penjualan</li>
                  <li>Penanganan keberatan dan penanganan pengaduan</li>
                </ul>
